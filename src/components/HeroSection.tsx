        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 animate-slide-up opacity-0 delay-100 font-heading">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 animate-slide-up opacity-0 delay-300">
                Building intelligent systems that bridge the gap between cutting-edge AI research and real-world applications.
              </p>

              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-8 animate-slide-up opacity-0 delay-400">
                <a
                  href="mailto:kavirajanekadesi@gmail.com"
                  className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors"
                >
                  <Mail size={16} />
                  <span className="hidden sm:inline">kavirajanekadesi@gmail.com</span>
                ...
                >
                  <Phone size={16} />
                  <span className="hidden sm:inline">+91 9551422206</span>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 animate-slide-up opacity-0 delay-500">
                <Button
                  asChild
              ...
              <div className="flex items-center justify-center lg:justify-start gap-6 mt-10 animate-slide-up opacity-0 delay-600">
                <a
              ...
              <div className="relative">
                ...
                <div className="relative w-56 h-56 sm:w-72 sm:h-72 lg:w-80 lg:h-80">
                  ...
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-4 py-2 bg-card border border-border rounded-full shadow-lg">
                    <span className="text-sm font-medium text-primary font-mono">AI Engineer</span>
                  </div>
                </div>
              </div>
            </div>
